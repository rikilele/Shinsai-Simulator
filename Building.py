...
class Building(ShowBase):
    def __init__(self, scene, name):
        if name == "concrete":
            ...
            self.buildHouse1(scene)
        elif name == "house2":
            self.buildHouse2(scene)
        elif name == "tower":
            self.buildTower(scene)
        elif name == "house3":
            self.buildHouse3(scene)
        elif name == "build":
            self.buildBuild(scene)
    ...
    def buildRBuilding(self, scene):
        for i in range(4):
            ...
            building.setScale(800)
            building.setHpr(0,0,0)
            building.setPos(i*800, -1000, -150)
    ...
    def buildHouse1(self, scene):
        for i in range(4):
            ...
            building.setHpr(0,0,0)
            building.setPos(i*800, -2000, -150)
    ...
    def buildHouse2(self, scene):
        for i in range(4):
            ...
            building.setScale(200)
            building.setHpr(0,0,0)
            building.setPos(i*800, -3000, -150)
    ...
    def buildBuild(self, scene):
        for i in range(4):
            ...
            building.setHpr(0,0,0)
            building.setPos(i*1500, 3000, -150)
